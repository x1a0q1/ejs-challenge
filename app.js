...
const truncateHelper = require(`${__dirname}/truncate.js`);
...
app.get("/", (req, res) => {
  const truncatedPosts = truncateHelper.truncatePostContent(posts);
  const params = {
...
app.get("/contact", (req, res) => {
  const params = { contactContent: contactContent };
